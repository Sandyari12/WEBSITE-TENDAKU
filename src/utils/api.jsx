import { jwtStorage } from './jwt_storage.jsx';
...
export const getProducts = async () => {
  const res = await fetch(`${BASE_URL}/api/v1/product/read`, {
...
export const getProductById = async (id) => {
  const res = await fetch(`${BASE_URL}/api/v1/product/read/${id}`, {
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` }
  });
...
export const updateProduct = async (id, formData) => {
  const res = await fetch(`${BASE_URL}/api/v1/product/update/${id}`, {
    method: 'PUT',
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` },
    body: formData,
  });
...
export const deleteProduct = async (id) => {
  const res = await fetch(`${BASE_URL}/api/v1/product/delete/${id}`, {
    method: 'DELETE',
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` },
  });
...
export const getRentals = async () => {
  const res = await fetch(`${BASE_URL}/api/v1/rental/read`, {
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` }
  });
...
export const updateRental = async (id, formData) => {
  const res = await fetch(`${BASE_URL}/api/v1/rental/update/${id}`, {
    method: 'PUT',
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` },
    body: formData,
  });
...
export const deleteRental = async (id) => {
  const res = await fetch(`${BASE_URL}/api/v1/rental/delete/${id}`, {
    method: 'DELETE',
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` },
  });
...
export const getRentalItemsByRentalId = async (rentalId) => {
  const res = await fetch(`${BASE_URL}/api/v1/rental_item/read?rental_id=${rentalId}`, {
    headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` }
  });
...
export async function getPlaylists() {
  const res = await fetch(`${BASE_URL}/api/v1/playlist/`);
  const data = await res.json();
  return data.datas || [];
}
...
export async function deletePlaylist(id) {
  const res = await fetch(`${BASE_URL}/api/v1/playlist/${id}`, {
    method: 'DELETE',
  });
...
export const updatePlaylist = async (id, formData) => {
  ...
  if (!res.ok) throw new Error('Gagal mengupdate playlist');
  return res.json();
};